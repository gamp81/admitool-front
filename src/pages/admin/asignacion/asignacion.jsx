...
import AutoPeriodo from '../asignacion/autoperiodo';
...
const Asignacion= ()=> {
    ...
    return (  
        ...
        <div className="header">
          <h3 className="me-auto">Asignacion </h3>  
          <button className="nuevo" onClick={()=>setOpenModal(true)} >Asignacion Curso</button>
          <AutoPeriodo open={openModal} onClose={()=>setOpenModal(false)} onProgramaCreated={handleNewPrograma}/>
